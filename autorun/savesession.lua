...
function loadMemoryScan()
	...
	dialog.Filter=translate("Magic Engine Scan files").." (*.CS)|*.CS"
...
s.LoadFromFile(getMagicEngineDir()..[[autorun\images\export128x128.png]])
...
local s=createPicture()
s.LoadFromFile(getMagicEngineDir()..[[autorun\images\import128x128.png]])
local ii=MainForm.mfImageList.add(s.Bitmap)
